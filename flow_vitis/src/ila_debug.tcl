open_hw_manager
connect_hw_server -url alveo3b.ethz.ch:3121 -allow_non_jtag
...
set_property PROBES.FILE {/home/runshi/Workspace/hw/build/tmop_ila10/build_dir.hw.xilinx_u280_xdma_201920_3/tmop.ltx} [get_hw_devices debug_bridge_0]
set_property FULL_PROBES.FILE {/home/runshi/Workspace/hw/build/tmop_ila10/build_dir.hw.xilinx_u280_xdma_201920_3/tmop.ltx} [get_hw_devices debug_bridge_0]
...
display_hw_ila_data [ get_hw_ila_data hw_ila_data_2 -of_objects [get_hw_ilas -of_objects [get_hw_devices debug_bridge_0] -filter {CELL_NAME=~"pfm_top_i/dynamic_region/tmop_1/inst/m_axiw_debug"}]]
...
set_property TRIGGER_COMPARE_VALUE eq1'bR [get_hw_probes pfm_top_i/dynamic_region/tmop_1/inst/m_axi_awvalid -of_objects [get_hw_ilas -of_objects [get_hw_devices debug_bridge_0] -filter {CELL_NAME=~"pfm_top_i/dynamic_region/tmop_1/inst/m_axiw_debug"}]]
# set_property TRIGGER_COMPARE_VALUE eq1'bR [get_hw_probes pfm_top_i/dynamic_region/tmop_1/inst/m_axi_arvalid -of_objects [get_hw_ilas -of_objects [get_hw_devices debug_bridge_0] -filter {CELL_NAME=~"pfm_top_i/dynamic_region/tmop_1/inst/m_axir_debug"}]]
...
run_hw_ila [get_hw_ilas -of_objects [get_hw_devices debug_bridge_0] -filter {CELL_NAME=~"pfm_top_i/dynamic_region/tmop_1/inst/m_axiw_debug"}]
